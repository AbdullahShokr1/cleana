...
class Block_Patterns {
	...
	public function register_block_patterns() {
		if ( function_exists( 'register_block_pattern' ) ) {
			...
			register_block_pattern(
				'cleana/cover',
				[
					'title' => __( 'Cleana Cover', 'cleana' ),
					'description' => __( 'Cleana Cover Block with image and text', 'cleana' ),
					'categories' => [ 'cover' ],
			...
			register_block_pattern(
				'cleana/two-columns',
				[
					'title' => __( 'Cleana Two Column', 'cleana' ),
					'description' => __( 'Cleana two columns with heading and text', 'cleana' ),
					'categories' => [ 'columns' ],
	...
	public function register_block_pattern_categories() {
		...
		$pattern_categories = [
			'cover' => __( 'Cover', 'cleana' ),
			'columns' => __( 'Columns', 'cleana' ),
		];
