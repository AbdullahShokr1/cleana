...
if ("serviceWorker" in navigator) {
    window.addEventListener("load", function() {
      navigator.serviceWorker
        .register("https://www.manzilak.live/serviceWorker.js")
        .then(res => console.log("service worker registered"))
        .catch(err => console.log("service worker not registered", err))
    })
}
const table=document.getElementById("my-table");const toggleButton=document.getElementById("toggle-table");let tableVisible=!1;function toggleTable(){if(tableVisible){table.style.display="none";tableVisible=!1}else{table.style.display="table";tableVisible=!0}}
