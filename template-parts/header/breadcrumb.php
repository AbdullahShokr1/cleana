    ...
    <nav class="flex bg-gray-50 text-gray-700 border border-gray-200 py-3 px-5 rounded-lg dark:bg-gray-800 dark:border-gray-700" aria-label="Breadcrumb" aria-label="Breadcrumb">
        <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
            ...
            <li aria-current="page">
                ...
                <span class="ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400">صفحة البحث</span>
                </section>
            </li>
            <?php
            }
            ...
            <li aria-current="page">
                ...
                <span class="ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400"><?php echo get_the_date( 'F j, Y' ); ?></span>
                </section>
            </li>
            <?php
            }
            ...
            <li aria-current="page">
                ...
                <span class="ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400"><?php esc_html( _e("البروفيل","cleana")); ?></span>
                </section>
            </li>
            <?php
            }
            ...
            <li aria-current="page">
                ...
                <span class="ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400"><?php esc_html(single_term_title()); ?></span>
                </section>
            </li>
            <?php
            }
            ...
            <li aria-current="page">
                ...
                <span class="ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400"><?php esc_html( _e("خطأ 404","cleana")); ?></span>
                </section>
            </li>
            <?php
            }else{
